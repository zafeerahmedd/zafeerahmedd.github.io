...
(() => {
  ...
  const names=['Motorcycle assembly','Stair-climbing robot','CFD studies','TerraExplorer','Electric go-kart','Solar desalination','FDM printer','Kinematic gear drive vehicle'];
